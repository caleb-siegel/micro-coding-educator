      ...
      <AnimatePresence>
        {isLoading && (
          ...
          >
            ...
            <div>
              <div style={{ fontSize: '16px', fontWeight: 800, color: '#f8fafc', marginBottom: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
                <Sparkles size={16} color="#818cf8" /> Crafting {loadingTopic} Challenge...
              </div>
